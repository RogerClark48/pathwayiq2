"""
cluster_pathway_refinement_test3.py
Re-test cluster pathway enrichment on clusters 2 and 11 with revised prompt
that replaces the purpose statement with a concrete definition and two examples.
...
OUTPUT_TXT = r"C:\Dev\pathwayiq2\scripts\cluster_pathway_refinement_test3_output.txt"
